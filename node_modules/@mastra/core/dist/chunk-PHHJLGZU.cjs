...
var MastraLLMV1 = class extends chunkRO47SMI7_cjs.MastraBase {
  #model;
  #mastra;
  #options;
  ...
  async __text({
    ...
    if (experimental_output) {
      ...
      if (chunkQDH6MVJ7_cjs.isZodType(experimental_output)) {
        schema = experimental_output;
        if (chunkBFIOQFGF_cjs.isZodArray(schema)) {
          schema = chunkBFIOQFGF_cjs.getZodDef(schema).type;
        }
    ...
    const argsForExecute = {
      ...
      experimental_output: schema ? chunkCC3OOESY_cjs.output_exports.object({
        schema
      }) : void 0
    };
    try {
      const result = await chunkKRAGJ433_cjs.executeWithContext({
        span: llmSpan,
        fn: () => chunkCC3OOESY_cjs.generateText(argsForExecute)
      });
  ...
  async __textObject({
    ...
    try {
      let output = "object";
      if (chunkBFIOQFGF_cjs.isZodArray(structuredOutput)) {
        output = "array";
        structuredOutput = chunkBFIOQFGF_cjs.getZodDef(structuredOutput).type;
      }
      ...
      try {
        const result = await chunkCC3OOESY_cjs.generateObject(argsForExecute);
        llmSpan?.end({
          output: {
            object: result.object,
            warnings: result.warnings
  ...
  __stream({
    ...
    try {
      return chunkKRAGJ433_cjs.executeWithContextSync({ span: llmSpan, fn: () => chunkCC3OOESY_cjs.streamText(argsForExecute) });
    } catch (e) {
      const mastraError = new chunk4U7ZLI36_cjs.MastraError(
        {
  ...
  __streamObject({
    ...
    try {
      ...
      try {
        return chunkCC3OOESY_cjs.streamObject(argsForExecute);
      } catch (e) {
        const mastraError = new chunk4U7ZLI36_cjs.MastraError(
          {
...
//# sourceMappingURL=chunk-PHHJLGZU.cjs.map
//# sourceMappingURL=chunk-PHHJLGZU.cjs.map