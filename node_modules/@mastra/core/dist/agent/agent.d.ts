 ...
 * ```
 */
export declare class Agent<TAgentId extends string = string, TTools extends ToolsInput = ToolsInput, TOutput = undefined, TRequestContext extends Record<string, any> | unknown = unknown> extends MastraBase {
    #private;
    id: TAgentId;
    name: string;
    source?: 'code' | 'stored';
    ...
    }): Record<string, Agent<string, ToolsInput, undefined, unknown>> | Promise<Record<string, Agent<string, ToolsInput, undefined, unknown>>>;
    /**
     ...
     */
    get requestContextSchema(): z.ZodType<TRequestContext, z.ZodTypeDef, TRequestContext> | undefined;
    /**
