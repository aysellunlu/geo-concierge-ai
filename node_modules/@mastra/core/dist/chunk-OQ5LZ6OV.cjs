...
var StepExecutor = class extends chunkRO47SMI7_cjs.MastraBase {
  mastra;
  constructor({ mastra }) {
    super({ name: "StepExecutor", component: chunk7XAECHYL_cjs.RegisteredLogger.WORKFLOW });
    this.mastra = mastra;
  }
        ...
        chunk7S6LA43E_cjs.createDeprecationProxy(
          {
            ...
            [chunkZCBG4ZQT_cjs.PUBSUB_SYMBOL]: this.mastra.pubsub,
            [chunkZCBG4ZQT_cjs.STREAM_FORMAT_SYMBOL]: void 0,
            // TODO
            engine: {},
...
async function processWorkflowLoop({
  ...
  const reqContext = new chunkVDKWYUGC_cjs.RequestContext(Object.entries(requestContext ?? {}));
  ...
  if (resumeData !== void 0 && forEachIndex === void 0 && currentResult?.output?.length > 0) {
    ...
    if (suspendedIndices.length > 0) {
      ...
      for (const suspIdx of indicesToResume) {
        updatedOutput[suspIdx] = chunkJZ6TH4HQ_cjs.createPendingMarker();
      }
...
var WorkflowEventProcessor = class extends EventProcessor {
  ...
  async processWorkflowStepRun({
    ...
    const rc = new chunkVDKWYUGC_cjs.RequestContext();
