...
var chunk3YMDR4OL_cjs = require('./chunk-3YMDR4OL.cjs');
var chunkMDC6VYA6_cjs = require('./chunk-MDC6VYA6.cjs');
...
var AISDKV6LanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      stream: chunkPHHJLGZU_cjs.createStreamFromGenerateResult(result)
    };
  }
...
function parseJsonEventStream({
  ...
  return stream.pipeThrough(new TextDecoderStream()).pipeThrough(new chunkSH4PCZ3X_cjs.EventSourceParserStream()).pipeThrough(
    new TransformStream({
...
var openaiErrorDataSchema = z4.z.object({
  error: z4.z.object({
    message: z4.z.string(),
    ...
    z4.z.object({
      ...
      usage: z4.z.object({
        ...
        prompt_tokens_details: z4.z.object({
          cached_tokens: z4.z.number().nullish()
        }).nullish(),
        completion_tokens_details: z4.z.object({
          reasoning_tokens: z4.z.number().nullish(),
          accepted_prediction_tokens: z4.z.number().nullish(),
          rejected_prediction_tokens: z4.z.number().nullish()
        }).nullish()
      }).nullish()
    })
  )
            ...
            delta: z4.z.object({
              ...
              tool_calls: z4.z.array(
                z4.z.object({
                  index: z4.z.number(),
                  id: z4.z.string().nullish(),
                  type: z4.z.literal("function").nullish(),
                  function: z4.z.object({
...
var openaiChatLanguageModelOptions = lazyValidator(
  () => zodSchema(
    z4.z.object({
       ...
       */
      logitBias: z4.z.record(z4.z.coerce.number(), z4.z.number()).optional(),
      /**
       ...
       */
      logprobs: z4.z.union([z4.z.boolean(), z4.z.number()]).optional(),
      /**
       ...
       */
      maxCompletionTokens: z4.z.number().optional(),
      /**
       * Whether to enable persistence in responses API.
       */
      store: z4.z.boolean().optional(),
      /**
       * Metadata to associate with the request.
       */
      metadata: z4.z.record(z4.z.string().max(64), z4.z.string().max(512)).optional(),
      /**
       * Parameters for prediction mode.
       */
      prediction: z4.z.record(z4.z.string(), z4.z.any()).optional(),
      /**
       ...
       * @default 'auto'
       */
      serviceTier: z4.z.enum(["auto", "flex", "priority", "default"]).optional(),
      /**
       ...
       */
      textVerbosity: z4.z.enum(["low", "medium", "high"]).optional(),
      /**
       ...
       * information.
       */
      safetyIdentifier: z4.z.string().optional()
    })
  )
);
      ...
      choices: z4.z.array(
        z4.z.object({
          ...
          logprobs: z4.z.object({
            ...
            top_logprobs: z4.z.array(z4.z.record(z4.z.string(), z4.z.number())).nullish()
          }).nullish()
        })
      ),
      usage: z4.z.object({
...
var openaiCompletionProviderOptions = lazyValidator(
  () => zodSchema(
    z4.z.object({
       ...
       */
      logitBias: z4.z.record(z4.z.string(), z4.z.number()).optional(),
      /**
      The suffix that comes after a completion of inserted text.
       */
      suffix: z4.z.string().optional(),
      /**
      A unique identifier representing your end-user, which can help OpenAI to
  ...
  () => zodSchema(
    z4.z.object({
      ...
      Only supported in text-embedding-3 and later models.
         */
      dimensions: z4.z.number().optional(),
      /**
      A unique identifier representing your end-user, which can help OpenAI to
      monitor and detect abuse. Learn more.
      */
    ...
    z4.z.object({
      ...
      segments: z4.z.array(
        z4.z.object({
          ...
          text: z4.z.string(),
          tokens: z4.z.array(z4.z.number()),
          temperature: z4.z.number(),
          avg_logprob: z4.z.number(),
          compression_ratio: z4.z.number(),
          no_speech_prob: z4.z.number()
        })
      ).nullish()
    })
  )
...
var openAITranscriptionProviderOptions = lazyValidator(
  () => zodSchema(
    z4.z.object({
       ...
       */
      include: z4.z.array(z4.z.string()).optional(),
      /**
       * The language of the input audio in ISO-639-1 format.
       */
      language: z4.z.string().optional(),
      /**
       * An optional text to guide the model's style or continue a previous audio segment.
       */
      prompt: z4.z.string().optional(),
      /**
       * The sampling temperature, between 0 and 1.
       * @default 0
       */
      temperature: z4.z.number().min(0).max(1).default(0).optional(),
      /**
       * The timestamp granularities to populate for this transcription.
       * @default ['segment']
       */
      timestampGranularities: z4.z.array(z4.z.enum(["word", "segment"])).default(["segment"]).optional()
    })
  )
);
var languageMap = {
  ...
  () => zodSchema(
    z4.z.object({
      action: z4.z.object({
        ...
        command: z4.z.array(z4.z.string()),
        timeoutMs: z4.z.number().optional(),
        user: z4.z.string().optional(),
...
var localShellOutputSchema = lazySchema(
  () => zodSchema(z4.z.object({ output: z4.z.string() }))
);
...
var openaiResponsesReasoningProviderOptionsSchema = z4.z.object({
  itemId: z4.z.string().nullish(),
  reasoningEncryptedContent: z4.z.string().nullish()
});
...
var openaiResponsesChunkSchema = lazyValidator(
  () => zodSchema(
    z4.z.union([
      ...
      z4.z.object({
        type: z4.z.enum(["response.completed", "response.incomplete"]),
        response: z4.z.object({
          incomplete_details: z4.z.object({ reason: z4.z.string() }).nullish(),
          usage: z4.z.object({
            input_tokens: z4.z.number(),
      ...
      z4.z.object({
        type: z4.z.literal("response.created"),
        response: z4.z.object({
          id: z4.z.string(),
      ...
      z4.z.object({
        type: z4.z.literal("response.output_item.added"),
        output_index: z4.z.number(),
        item: z4.z.discriminatedUnion("type", [
          z4.z.object({
            type: z4.z.literal("message"),
            id: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("reasoning"),
            id: z4.z.string(),
            encrypted_content: z4.z.string().nullish()
          }),
          z4.z.object({
            type: z4.z.literal("function_call"),
            id: z4.z.string(),
            call_id: z4.z.string(),
            name: z4.z.string(),
            arguments: z4.z.string()
          ...
          z4.z.object({
            type: z4.z.literal("web_search_call"),
            id: z4.z.string(),
            status: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("computer_call"),
            id: z4.z.string(),
            status: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("file_search_call"),
            id: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("image_generation_call"),
            id: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("code_interpreter_call"),
            id: z4.z.string(),
            container_id: z4.z.string(),
            code: z4.z.string().nullable(),
            outputs: z4.z.array(
              z4.z.discriminatedUnion("type", [
                z4.z.object({ type: z4.z.literal("logs"), logs: z4.z.string() }),
                z4.z.object({ type: z4.z.literal("image"), url: z4.z.string() })
              ])
            ).nullable(),
            status: z4.z.string()
          })
      ...
      z4.z.object({
        type: z4.z.literal("response.output_item.done"),
        output_index: z4.z.number(),
        item: z4.z.discriminatedUnion("type", [
          z4.z.object({
            type: z4.z.literal("message"),
          ...
          z4.z.object({
            type: z4.z.literal("local_shell_call"),
            id: z4.z.string(),
            call_id: z4.z.string(),
            action: z4.z.object({
              type: z4.z.literal("exec"),
              command: z4.z.array(z4.z.string()),
              timeout_ms: z4.z.number().optional(),
              user: z4.z.string().optional(),
      ...
      z4.z.object({
        type: z4.z.literal("response.function_call_arguments.delta"),
        item_id: z4.z.string(),
        output_index: z4.z.number(),
        delta: z4.z.string()
      }),
      z4.z.object({
        type: z4.z.literal("response.image_generation_call.partial_image"),
        item_id: z4.z.string(),
        output_index: z4.z.number(),
        partial_image_b64: z4.z.string()
      }),
      z4.z.object({
        type: z4.z.literal("response.code_interpreter_call_code.delta"),
        item_id: z4.z.string(),
        output_index: z4.z.number(),
        delta: z4.z.string()
      }),
      z4.z.object({
        type: z4.z.literal("response.code_interpreter_call_code.done"),
        item_id: z4.z.string(),
        output_index: z4.z.number(),
        code: z4.z.string()
      }),
      z4.z.object({
        type: z4.z.literal("response.output_text.annotation.added"),
        annotation: z4.z.discriminatedUnion("type", [
          z4.z.object({
            type: z4.z.literal("url_citation"),
            start_index: z4.z.number(),
            end_index: z4.z.number(),
          ...
          z4.z.object({
            type: z4.z.literal("file_citation"),
            file_id: z4.z.string(),
      ...
      z4.z.object({
        type: z4.z.literal("response.reasoning_summary_part.added"),
        item_id: z4.z.string(),
        summary_index: z4.z.number()
      }),
      z4.z.object({
        type: z4.z.literal("response.reasoning_summary_text.delta"),
        item_id: z4.z.string(),
        summary_index: z4.z.number(),
        delta: z4.z.string()
      }),
      z4.z.object({
        type: z4.z.literal("response.reasoning_summary_part.done"),
        item_id: z4.z.string(),
        summary_index: z4.z.number()
      }),
      z4.z.object({
      ...
      output: z4.z.array(
        z4.z.discriminatedUnion("type", [
          ...
          z4.z.object({
            ...
            summary: z4.z.array(
              z4.z.object({
                type: z4.z.literal("summary_text"),
                text: z4.z.string()
              })
            )
          })
...
var openaiResponsesProviderOptionsSchema = lazyValidator(
  () => zodSchema(
    z4.z.object({
       ...
       */
      logprobs: z4.z.union([z4.z.boolean(), z4.z.number().min(1).max(TOP_LOGPROBS_MAX)]).optional(),
      /**
       * The maximum number of total calls to built-in tools that can be processed in a response.
       * This maximum number applies across all built-in tool calls, not per individual tool.
       * Any further attempts to call a tool by the model will be ignored.
       */
      maxToolCalls: z4.z.number().nullish(),
      metadata: z4.z.any().nullish(),
      ...
      serviceTier: z4.z.enum(["auto", "flex", "priority", "default"]).nullish(),
      store: z4.z.boolean().nullish(),
      strictJsonSchema: z4.z.boolean().nullish(),
      textVerbosity: z4.z.enum(["low", "medium", "high"]).nullish(),
      truncation: z4.z.enum(["auto", "disabled"]).nullish(),
      user: z4.z.string().nullish()
    })
  )
);
...
var comparisonFilterSchema = z4.z.object({
  key: z4.z.string(),
  type: z4.z.enum(["eq", "ne", "gt", "gte", "lt", "lte"]),
  value: z4.z.union([z4.z.string(), z4.z.number(), z4.z.boolean()])
});
var compoundFilterSchema = z4.z.object({
  type: z4.z.enum(["and", "or"]),
  filters: z4.z.array(
...
var fileSearchArgsSchema = lazySchema(
  () => zodSchema(
    z4.z.object({
      ...
      ranking: z4.z.object({
        ranker: z4.z.string().optional(),
        scoreThreshold: z4.z.number().optional()
      }).optional(),
      filters: z4.z.union([comparisonFilterSchema, compoundFilterSchema]).optional()
    })
  )
);
  ...
  () => zodSchema(
    z4.z.object({
      action: z4.z.discriminatedUnion("type", [
        z4.z.object({
          type: z4.z.literal("search"),
          query: z4.z.string().optional()
        }),
        z4.z.object({
          type: z4.z.literal("openPage"),
          url: z4.z.string()
        }),
        z4.z.object({
          type: z4.z.literal("find"),
...
var imageGenerationArgsSchema = lazySchema(
  () => zodSchema(
    z4.z.object({
      ...
      inputImageMask: z4.z.object({
        fileId: z4.z.string().optional(),
        imageUrl: z4.z.string().optional()
      }).optional(),
      model: z4.z.string().optional(),
      moderation: z4.z.enum(["auto"]).optional(),
      outputCompression: z4.z.number().int().min(0).max(100).optional(),
      outputFormat: z4.z.enum(["png", "jpeg", "webp"]).optional(),
      partialImages: z4.z.number().int().min(0).max(3).optional(),
      quality: z4.z.enum(["auto", "low", "medium", "high"]).optional(),
      size: z4.z.enum(["1024x1024", "1024x1536", "1536x1024", "auto"]).optional()
    }).strict()
  )
);
var imageGenerationInputSchema = lazySchema(() => zodSchema(z4.z.object({})));
var imageGenerationOutputSchema = lazySchema(
  () => zodSchema(z4.z.object({ result: z4.z.string() }))
);
...
var AzureOpenAIGateway = class extends chunkSH4PCZ3X_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
    this.validateConfig();
...
function getStaticProvidersByGateway(name14) {
  return Object.fromEntries(Object.entries(chunk3YMDR4OL_cjs.PROVIDER_REGISTRY).filter(([_provider, config]) => config.gateway === name14));
}
var defaultGateways = [new chunk2P6DD7M5_cjs.NetlifyGateway(), new chunkMDC6VYA6_cjs.ModelsDevGateway(getStaticProvidersByGateway(`models.dev`))];
var ModelRouterLanguageModel = class _ModelRouterLanguageModel {
  ...
  constructor(config, customGateways) {
    ...
    const parsed = chunkMDC6VYA6_cjs.parseModelRouterId(normalizedConfig.id, gatewayPrefix);
  ...
  async _fetchSupportedUrls() {
    ...
    try {
      ...
      const model = await this.resolveLanguageModel({
        ...
        ...chunkMDC6VYA6_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix)
      });
      ...
      if (typeof modelSupportedUrls.then === "function") {
        const resolved = await modelSupportedUrls;
        return resolved ?? {};
      }
  ...
  async doGenerate(options) {
    ...
    const aiSDKV5Model = new chunkPHHJLGZU_cjs.AISDKV5LanguageModel(model);
  ...
  async resolveLanguageModel({
    ...
    if (this.config.url) {
      const modelInstance2 = chunkSH4PCZ3X_cjs.createOpenAICompatible({
        name: providerId,
        apiKey,
...
async function resolveModelConfig(modelConfig, requestContext = new chunkVDKWYUGC_cjs.RequestContext(), mastra) {
  if (typeof modelConfig === "function") {
    modelConfig = await modelConfig({ requestContext, mastra });
  }
  if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof chunkPHHJLGZU_cjs.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel) {
    return modelConfig;
  }
  if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
    if (modelConfig.specificationVersion === "v2") {
      return new chunkPHHJLGZU_cjs.AISDKV5LanguageModel(modelConfig);
    }
...
var ModelRouterEmbeddingModel = class {
  ...
  constructor(config) {
    ...
    if (normalizedConfig.url) {
      ...
      this.providerModel = chunkSH4PCZ3X_cjs.createOpenAICompatible({
      ...
      const registry = chunk3YMDR4OL_cjs.GatewayRegistry.getInstance();
      ...
      if (normalizedConfig.providerId === "openai") {
        this.providerModel = chunkSH4PCZ3X_cjs.createOpenAI({ apiKey }).textEmbeddingModel(
          normalizedConfig.modelId
        );
      } else if (normalizedConfig.providerId === "google") {
        this.providerModel = chunkSH4PCZ3X_cjs.createGoogleGenerativeAI({ apiKey }).textEmbedding(
          normalizedConfig.modelId
        );
      } else {
...
//# sourceMappingURL=chunk-QSN5KQXZ.cjs.map
//# sourceMappingURL=chunk-QSN5KQXZ.cjs.map