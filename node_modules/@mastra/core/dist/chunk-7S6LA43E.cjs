...
var z10__default = /*#__PURE__*/_interopDefault(z10);
  ...
  return {
    tools: filteredTools.map(([name, tool2]) => {
      try {
        ...
        const sdkTool = chunkPM3UIIBK_cjs.tool({
          type: "function",
          ...tool2,
          inputSchema
        });
...
var ProcessorRunner = class _ProcessorRunner {
   ...
   */
  async executeWorkflowAsProcessor(workflow, input, tracingContext, requestContext, writer, abortSignal) {
  ...
  async runOutputProcessors(messageList, tracingContext, requestContext, retryCount = 0, writer) {
...
function asJsonSchema(schema) {
  ...
  if (schemaCompat.isZodType(schema)) {
    return zodToJson.zodToJsonSchema(schema);
  }
  if (schema.jsonSchema) {
    return schema.jsonSchema;
  }
  return chunkPM3UIIBK_cjs.asSchema(schema).jsonSchema;
}
...
${z4__default.default.prettifyError(result.error)}
`,
                details: {
    ...
    try {
      if (typeof this.schema === "object" && !this.schema.jsonSchema) {
        const result = await safeValidateTypes({ value, schema: chunkPM3UIIBK_cjs.jsonSchema(this.schema) });
        return result;
...
var ObjectFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const { value: currentObjectJson, state } = await chunkZIEQA3YP_cjs.parsePartialJson(processedAccumulatedText);
    if (this.validatePartialChunks && this.partialSchema) {
      const result = this.partialSchema?.safeParse(currentObjectJson);
      if (result.success && result.data && result.data !== void 0 && !chunkZIEQA3YP_cjs.isDeepEqualData(previousObject, result.data)) {
        return {
          shouldEmit: true,
    ...
    if (currentObjectJson !== void 0 && currentObjectJson !== null && typeof currentObjectJson === "object" && !chunkZIEQA3YP_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
      return {
  ...
  async validateAndTransformFinal(finalRawValue) {
    ...
    const { value } = await chunkZIEQA3YP_cjs.parsePartialJson(rawValue);
...
var ArrayFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const processedAccumulatedText = this.preprocessText(accumulatedText);
    const { value: currentObjectJson, state: parseState } = await chunkZIEQA3YP_cjs.parsePartialJson(processedAccumulatedText);
    if (currentObjectJson !== void 0 && !chunkZIEQA3YP_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
      ...
      if (!chunkZIEQA3YP_cjs.isDeepEqualData(this.textPreviousFilteredArray, filteredElements)) {
...
var EnumFormatHandler = class extends BaseFormatHandler {
  ...
  findBestEnumMatch(partialResult) {
    ...
    let enumValues;
    if (this.isZodSchema(this.schema)) {
      const convertedSchema = zodToJson.zodToJsonSchema(this.schema);
      enumValues = convertedSchema?.enum;
    } else if (typeof this.schema === "object" && !this.schema.jsonSchema) {
      const wrappedSchema = chunkPM3UIIBK_cjs.jsonSchema(this.schema);
  ...
  async processPartialChunk({
    ...
    const processedAccumulatedText = this.preprocessText(accumulatedText);
    const { value: currentObjectJson } = await chunkZIEQA3YP_cjs.parsePartialJson(processedAccumulatedText);
    if (currentObjectJson !== void 0 && currentObjectJson !== null && typeof currentObjectJson === "object" && !Array.isArray(currentObjectJson) && "result" in currentObjectJson && typeof currentObjectJson.result === "string" && !chunkZIEQA3YP_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
  ...
  async validateAndTransformFinal(rawFinalValue) {
    ...
    const { value } = await chunkZIEQA3YP_cjs.parsePartialJson(processedValue);
...
var MastraModelOutput = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  #emitter = new EventEmitter2.EventEmitter();
  #bufferedSteps = [];
...
var WorkflowRunOutput = class {
  ...
  #consumptionStarted = false;
  #baseStream;
  #emitter = new EventEmitter2__default.default();
  #bufferedChunks = [];
  #streamFinished = false;
  #streamError;
  #delayedPromises = {
...
var MessageContentSchema = z10.z.object({
...
var ProcessorMessageContentSchema = z10.z.object({
  /** Format version - 2 corresponds to AI SDK v4 UIMessage format */
  format: z10.z.literal(2),
  /** Array of message parts (text, images, tool calls, etc.) */
  parts: z10.z.array(MessagePartSchema),
...
var ProcessorMessageSchema = z10.z.object({
  /** Unique message identifier */
  id: z10.z.string(),
  /** Message role */
  role: z10.z.enum(["user", "assistant", "system", "tool"]),
  /** When the message was created */
  createdAt: z10.z.coerce.date(),
  /** Thread identifier for conversation grouping */
  threadId: z10.z.string().optional(),
  /** Resource identifier */
  resourceId: z10.z.string().optional(),
  /** Message type */
  type: z10.z.string().optional(),
  /** Message content with parts */
  content: ProcessorMessageContentSchema
}).passthrough();
var messageListSchema = z10.z.custom();
var messagesSchema = z10.z.array(ProcessorMessageSchema);
var SystemMessageTextPartSchema = z10.z.object({
  type: z10.z.literal("text"),
  text: z10.z.string()
}).passthrough();
z10.z.object({
  role: z10.z.literal("system"),
  content: z10.z.union([z10.z.string(), z10.z.array(SystemMessageTextPartSchema)]),
  /** Optional experimental provider-specific extensions */
  experimental_providerMetadata: z10.z.record(z10.z.unknown()).optional()
}).passthrough();
var CoreMessageSchema = z10.z.object({
  role: z10.z.enum(["system", "user", "assistant", "tool"]),
  content: z10.z.unknown()
}).passthrough();
var systemMessagesSchema = z10.z.array(CoreMessageSchema);
var toolCallSchema = z10.z.object({
  toolName: z10.z.string(),
  toolCallId: z10.z.string(),
  args: z10.z.unknown()
});
var retryCountSchema = z10.z.number().optional();
var ProcessorInputPhaseSchema = z10.z.object({
  phase: z10.z.literal("input"),
  messages: messagesSchema,
  messageList: messageListSchema,
  systemMessages: systemMessagesSchema.optional(),
  retryCount: retryCountSchema
});
var ProcessorInputStepPhaseSchema = z10.z.object({
  phase: z10.z.literal("inputStep"),
  messages: messagesSchema,
  messageList: messageListSchema,
  stepNumber: z10.z.number().describe("The current step number (0-indexed)"),
  systemMessages: systemMessagesSchema.optional(),
  retryCount: retryCountSchema,
  // Model and tools configuration (can be modified by processors)
  model: z10.z.custom().optional().describe("Current model for this step"),
  tools: z10.z.custom().optional().describe("Current tools available for this step"),
  toolChoice: z10.z.custom().optional().describe("Current tool choice setting"),
  activeTools: z10.z.array(z10.z.string()).optional().describe("Currently active tools"),
  providerOptions: z10.z.custom().optional().describe("Provider-specific options"),
  modelSettings: z10.z.custom().optional().describe("Model settings (temperature, etc.)"),
  structuredOutput: z10.z.custom().optional().describe("Structured output configuration"),
  steps: z10.z.custom().optional().describe("Results from previous steps")
});
var ProcessorOutputStreamPhaseSchema = z10.z.object({
  phase: z10.z.literal("outputStream"),
  part: z10.z.unknown().nullable().describe("The current chunk being processed. Can be null to skip."),
  streamParts: z10.z.array(z10.z.unknown()).describe("All chunks seen so far"),
  state: z10.z.record(z10.z.unknown()).describe("Mutable state object that persists across chunks"),
  messageList: messageListSchema.optional(),
  retryCount: retryCountSchema
});
var ProcessorOutputResultPhaseSchema = z10.z.object({
  phase: z10.z.literal("outputResult"),
  messages: messagesSchema,
  messageList: messageListSchema,
  retryCount: retryCountSchema
});
var ProcessorOutputStepPhaseSchema = z10.z.object({
  phase: z10.z.literal("outputStep"),
  messages: messagesSchema,
  messageList: messageListSchema,
  stepNumber: z10.z.number().describe("The current step number (0-indexed)"),
  finishReason: z10.z.string().optional().describe("The finish reason from the LLM (stop, tool-use, length, etc.)"),
  toolCalls: z10.z.array(toolCallSchema).optional().describe("Tool calls made in this step (if any)"),
  text: z10.z.string().optional().describe("Generated text from this step"),
  systemMessages: systemMessagesSchema.optional(),
  retryCount: retryCountSchema
});
var ProcessorStepInputSchema = z10.z.discriminatedUnion("phase", [
...
var ProcessorStepOutputSchema = z10.z.object({
  // Phase field
  phase: z10.z.enum(["input", "inputStep", "outputStream", "outputResult", "outputStep"]),
  // Message-based fields (used by most phases)
  messages: messagesSchema.optional(),
  messageList: messageListSchema.optional(),
  systemMessages: systemMessagesSchema.optional(),
  // Step-based fields
  stepNumber: z10.z.number().optional(),
  // Stream-based fields
  part: z10.z.unknown().nullable().optional(),
  streamParts: z10.z.array(z10.z.unknown()).optional(),
  state: z10.z.record(z10.z.unknown()).optional(),
  // Output step fields
  finishReason: z10.z.string().optional(),
  toolCalls: z10.z.array(toolCallSchema).optional(),
  text: z10.z.string().optional(),
  // Retry count
  retryCount: z10.z.number().optional(),
  // Model and tools configuration (for inputStep phase)
  model: z10.z.custom().optional(),
  tools: z10.z.custom().optional(),
  toolChoice: z10.z.custom().optional(),
  activeTools: z10.z.array(z10.z.string()).optional(),
  providerOptions: z10.z.custom().optional(),
  modelSettings: z10.z.custom().optional(),
  structuredOutput: z10.z.custom().optional(),
...
var ExecutionEngine = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  constructor({ mastra, options }) {
    super({ name: "ExecutionEngine", component: chunk7XAECHYL_cjs.RegisteredLogger.WORKFLOW });
    this.mastra = mastra;
    this.options = options;
  }
      ...
      const context = createDeprecationProxy(
        {
          ...
          [chunkZCBG4ZQT_cjs.PUBSUB_SYMBOL]: pubsub,
          [chunkZCBG4ZQT_cjs.STREAM_FORMAT_SYMBOL]: executionContext.format,
...
function createStepFromAgent(params, agentOrToolOptions) {
  ...
  return {
    ...
    execute: async ({
      ...
      runId,
      [chunkZCBG4ZQT_cjs.PUBSUB_SYMBOL]: pubsub,
      [chunkZCBG4ZQT_cjs.STREAM_FORMAT_SYMBOL]: streamFormat,
      requestContext,
      tracingContext,
      abortSignal,
      abort,
...
var Workflow = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  constructor({
    ...
    super({ name: id, component: chunk7XAECHYL_cjs.RegisteredLogger.WORKFLOW });
    this.id = id;
   ...
   */
  sleep(duration) {
    const id = `sleep_${this.#mastra?.generateId({ idType: "step", source: "workflow", entityId: this.id, stepType: "sleep" }) || crypto2.randomUUID()}`;
   ...
   */
  sleepUntil(date) {
    const id = `sleep_${this.#mastra?.generateId({ idType: "step", source: "workflow", entityId: this.id, stepType: "sleep-until" }) || crypto2.randomUUID()}`;
  ...
  map(mappingConfig, stepOptions) {
    if (typeof mappingConfig === "function") {
      const mappingStep2 = createStep({
        id: stepOptions?.id || `mapping_${this.#mastra?.generateId({ idType: "step", source: "workflow", entityId: this.id, stepType: "mapping" }) || crypto2.randomUUID()}`,
        inputSchema: z10.z.any(),
        outputSchema: z10.z.any(),
...
` + errors.map((e) => `- ${e.path?.join(".")}: ${e.message}`).join("\n")
  ...
  async _start({
    ...
    const result = await this.executionEngine.execute({
      ...
      pubsub: this.pubsub,
      retryConfig: this.retryConfig,
      requestContext: requestContext ?? new chunkVDKWYUGC_cjs.RequestContext(),
  ...
  async _resume(params) {
    ...
    const requestContextToUse = params.requestContext ?? new chunkVDKWYUGC_cjs.RequestContext();
  ...
  async _restart({
    ...
    const requestContextToUse = requestContext ?? new chunkVDKWYUGC_cjs.RequestContext();
...
var languageModelUsageSchema = z10__default.default.object({
  inputTokens: z10__default.default.number().optional(),
  outputTokens: z10__default.default.number().optional(),
  totalTokens: z10__default.default.number().optional(),
  reasoningTokens: z10__default.default.number().optional(),
  cachedInputTokens: z10__default.default.number().optional()
});
var llmIterationStepResultSchema = z10__default.default.object({
  reason: z10__default.default.string(),
  warnings: z10__default.default.array(z10__default.default.any()),
  isContinued: z10__default.default.boolean(),
  logprobs: z10__default.default.any().optional(),
  totalUsage: languageModelUsageSchema.optional(),
  headers: z10__default.default.record(z10__default.default.string()).optional(),
  messageId: z10__default.default.string().optional(),
  request: z10__default.default.record(z10__default.default.any()).optional()
});
var llmIterationOutputSchema = z10__default.default.object({
  messageId: z10__default.default.string(),
  messages: z10__default.default.object({
    all: z10__default.default.array(z10__default.default.any()),
    // ModelMessage[] but too complex to validate at runtime
    user: z10__default.default.array(z10__default.default.any()),
    nonUser: z10__default.default.array(z10__default.default.any())
  }),
  output: z10__default.default.object({
    text: z10__default.default.string().optional(),
    reasoning: z10__default.default.array(z10__default.default.any()).optional(),
    reasoningText: z10__default.default.string().optional(),
    files: z10__default.default.array(z10__default.default.any()).optional(),
    // GeneratedFile[]
    toolCalls: z10__default.default.array(z10__default.default.any()).optional(),
    // TypedToolCall[]
    toolResults: z10__default.default.array(z10__default.default.any()).optional(),
    // TypedToolResult[]
    sources: z10__default.default.array(z10__default.default.any()).optional(),
    // LanguageModelV2Source[]
    staticToolCalls: z10__default.default.array(z10__default.default.any()).optional(),
    dynamicToolCalls: z10__default.default.array(z10__default.default.any()).optional(),
    staticToolResults: z10__default.default.array(z10__default.default.any()).optional(),
    dynamicToolResults: z10__default.default.array(z10__default.default.any()).optional(),
    usage: languageModelUsageSchema,
    steps: z10__default.default.array(z10__default.default.any())
    // StepResult[]
  }),
  metadata: z10__default.default.object({
    id: z10__default.default.string().optional(),
    model: z10__default.default.string().optional(),
    modelId: z10__default.default.string().optional(),
    modelMetadata: z10__default.default.object({
      modelId: z10__default.default.string(),
      modelVersion: z10__default.default.string(),
      modelProvider: z10__default.default.string()
    }).optional(),
    timestamp: z10__default.default.date().optional(),
    providerMetadata: z10__default.default.record(z10__default.default.any()).optional(),
    headers: z10__default.default.record(z10__default.default.string()).optional(),
    request: z10__default.default.record(z10__default.default.any()).optional()
  }),
  stepResult: llmIterationStepResultSchema,
  processorRetryCount: z10__default.default.number().optional(),
  processorRetryFeedback: z10__default.default.string().optional()
});
var toolCallInputSchema = z10__default.default.object({
  toolCallId: z10__default.default.string(),
  toolName: z10__default.default.string(),
  args: z10__default.default.record(z10__default.default.any()),
  providerMetadata: z10__default.default.record(z10__default.default.any()).optional(),
  providerExecuted: z10__default.default.boolean().optional(),
  output: z10__default.default.any().optional()
});
var toolCallOutputSchema = toolCallInputSchema.extend({
  result: z10__default.default.any(),
  error: z10__default.default.any().optional()
});
...
var AISDKV5InputStream = class extends MastraModelInput {
  ...
  constructor({
    ...
    this.#generateId = generateId2 ?? chunkPM3UIIBK_cjs.generateId;
  }
  async transform({
    runId,
    stream,
      ...
      try {
        ...
        return await pRetry.default(
          ...
          },
          {
            ...
            signal: abortSignal,
            shouldRetry(context) {
              if (chunkPM3UIIBK_cjs.APICallError.isInstance(context.error)) {
      ...
      const { outputStream, callBail, runState, stepTools, stepWorkspace } = await executeStreamWithFallbackModels(
        ...
        if (inputStepProcessors && inputStepProcessors.length > 0) {
          const processorRunner = new ProcessorRunner({
            ...
            outputProcessors: [],
            logger: logger || new chunk7XAECHYL_cjs.ConsoleLogger({ level: "error" }),
...
Analyse the suspended tools: ${JSON.stringify(suspendedTools)}, using the messages available to you and the resumeSchema of each suspended tool, find the tool whose resumeData you can construct properly.
        ...
        try {
          ...
          const isUpstreamError = chunkPM3UIIBK_cjs.APICallError.isInstance(error);
          if (isUpstreamError) {
...
function createLLMMappingStep({ models, _internal, ...rest }, llmExecutionStep) {
  ...
  return createStep({
    ...
    inputSchema: z10__default.default.array(toolCallOutputSchema),
    outputSchema: llmIterationOutputSchema,
...
function loop({
  ...
  let loggerToUse = logger || new chunk7XAECHYL_cjs.ConsoleLogger({
    level: "debug"
  });
  ...
  const internalToUse = {
    ...
    generateId: _internal?.generateId || (() => chunkPM3UIIBK_cjs.generateId()),
...
var MastraScorer = class _MastraScorer {
  ...
  toMastraWorkflow() {
    ...
    const workflow = createWorkflow({
      ...
      outputSchema: z10.z.object({
        run: z10.z.any(),
        score: z10.z.number(),
        reason: z10.z.string().optional(),
        preprocessResult: z10.z.any().optional(),
        analyzeResult: z10.z.any().optional(),
        preprocessPrompt: z10.z.string().optional(),
        analyzePrompt: z10.z.string().optional(),
        generateScorePrompt: z10.z.string().optional(),
        generateReasonPrompt: z10.z.string().optional()
      }),
      options: {
  ...
  async executePromptStep(scorerStep, tracingContext, context) {
    ...
    if (scorerStep.name === "generateScore") {
      const schema = z10.z.object({ score: z10.z.number() });
      let result;
...
var defaultCompletionSchema = z10.z.object({
...
var finalResultSchema = z10.z.object({
  finalResult: z10.z.string().optional().describe("The final result text to return to the user, omit if primitive result is sufficient")
});
...
var MastraLLMVNext = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  stream({
    resumeContext,
    runId,
    stopWhen = chunkZIEQA3YP_cjs.stepCountIs(5),
    maxSteps,
    tools = {},
    modelSettings,
    toolChoice = "auto",
    ...
    if (maxSteps && typeof maxSteps === "number") {
      stopWhenToUse = chunkZIEQA3YP_cjs.stepCountIs(maxSteps);
    } else {
...
var PRIMITIVE_TYPES = z10__default.default.enum(["agent", "workflow", "none", "tool"]);
...
async function safeParseLLMJson(text) {
  ...
  const { value, state } = await chunkZIEQA3YP_cjs.parsePartialJson(preprocessed);
...
async function getRoutingAgent({
  ...
  const workflowList = Object.entries(workflowsToUse).map(([name, workflow]) => {
    return ` - **${name}**: ${workflow.description}, input schema: ${JSON.stringify(
      chunk4WQYXT2I_cjs.zodToJsonSchema(workflow.inputSchema ?? z10__default.default.object({}))
    )}`;
  }).join("\n");
...
async function createNetworkLoop({
  ...
  const processorRunner = configuredOutputProcessors.length > 0 ? new ProcessorRunner({
    outputProcessors: configuredOutputProcessors,
    inputProcessors: [],
    logger: agent.getMastraInstance()?.getLogger() || chunk6BJ7XHRH_cjs.noopLogger,
    agentName: agent.name
  }) : null;
  const routingStep = createStep({
    id: "routing-agent-step",
    inputSchema: z10__default.default.object({
      task: z10__default.default.string(),
      primitiveId: z10__default.default.string(),
      primitiveType: PRIMITIVE_TYPES,
      result: z10__default.default.string().optional(),
      iteration: z10__default.default.number(),
      threadId: z10__default.default.string().optional(),
      threadResourceId: z10__default.default.string().optional(),
      isOneOff: z10__default.default.boolean(),
      verboseIntrospection: z10__default.default.boolean()
    }),
    outputSchema: z10__default.default.object({
      task: z10__default.default.string(),
      primitiveId: z10__default.default.string(),
      primitiveType: PRIMITIVE_TYPES,
      prompt: z10__default.default.string(),
      result: z10__default.default.string(),
      isComplete: z10__default.default.boolean().optional(),
      selectionReason: z10__default.default.string(),
      iteration: z10__default.default.number(),
      conversationContext: z10__default.default.array(z10__default.default.any()).optional()
    }),
    execute: async ({ inputData, getInitData, writer }) => {
      ...
      const options = {
        structuredOutput: {
          schema: z10__default.default.object({
            primitiveId: z10__default.default.string().describe("The id of the primitive to be called"),
            primitiveType: PRIMITIVE_TYPES.describe("The type of the primitive to be called"),
            prompt: z10__default.default.string().describe("The json string or text value to be sent to the primitive"),
            selectionReason: z10__default.default.string().describe("The reason you picked the primitive")
          })
        },
        requestContext,
        maxSteps: 1,
  ...
  const workflowStep = createStep({
    ...
    execute: async ({ inputData, writer, getInitData, suspend, resumeData, mastra }) => {
      ...
      if (workflowState?.status === "suspended") {
        ...
        if (wflowStepSchema) {
          resumeSchema = JSON.stringify(chunk4WQYXT2I_cjs.zodToJsonSchema(wflowStepSchema));
        } else {
          resumeSchema = "";
        }
      }
  ...
  const toolStep = createStep({
    ...
    resumeSchema: z10__default.default.object({
      approved: z10__default.default.boolean().describe("Controls if the tool call is approved or not, should be true when approved and false when declined")
    }),
      ...
      if (toolRequiresApproval) {
        if (!resumeData) {
          const requireApprovalResumeSchema = JSON.stringify(
            chunk4WQYXT2I_cjs.zodToJsonSchema(
              z10__default.default.object({
                approved: z10__default.default.boolean().describe(
                  "Controls if the tool call is approved or not, should be true when approved and false when declined"
                )
                      ...
                      metadata: {
                        ...
                        suspendedTools: {
                          [inputData.primitiveId]: {
                            ...
                            suspendPayload,
                            type: "suspension",
                            resumeSchema: suspendOptions?.resumeSchema ?? JSON.stringify(chunk4WQYXT2I_cjs.zodToJsonSchema(tool2.resumeSchema)),
                            runId,
                            primitiveType: "tool",
                            primitiveId: inputData.primitiveId
                          }
  ...
  const finishStep = createStep({
    ...
    outputSchema: z10__default.default.object({
      task: z10__default.default.string(),
      result: z10__default.default.string(),
      isComplete: z10__default.default.boolean(),
      iteration: z10__default.default.number()
    }),
  ...
  const networkWorkflow = createWorkflow({
    ...
    outputSchema: z10__default.default.object({
      ...
      result: z10__default.default.string(),
      isComplete: z10__default.default.boolean().optional(),
      completionReason: z10__default.default.string().optional(),
      iteration: z10__default.default.number(),
      threadId: z10__default.default.string().optional(),
      threadResourceId: z10__default.default.string().optional(),
      isOneOff: z10__default.default.boolean()
...
async function networkLoop({
        ...
        if (requireApprovalMetadata || suspendedTools) {
          ...
          `;
              ...
              const result = llm.stream({
                ...
                structuredOutput: {
                  schema: z10__default.default.object({
                    resumeData: z10__default.default.string()
                  })
                }
              });
              const object = await result.object;
  ...
  const validationStep = createStep({
    ...
    outputSchema: z10__default.default.object({
      ...
      prompt: z10__default.default.string(),
      result: z10__default.default.string(),
      structuredObject: z10__default.default.any().optional(),
      isComplete: z10__default.default.boolean().optional(),
      completionReason: z10__default.default.string().optional(),
      iteration: z10__default.default.number(),
      validationPassed: z10__default.default.boolean().optional(),
      validationFeedback: z10__default.default.string().optional()
    }),
    execute: async ({ inputData, writer }) => {
  ...
  const finalStep = createStep({
    ...
    outputSchema: z10__default.default.object({
      ...
      prompt: z10__default.default.string(),
      result: z10__default.default.string(),
      object: z10__default.default.any().optional(),
      isComplete: z10__default.default.boolean().optional(),
      completionReason: z10__default.default.string().optional(),
      iteration: z10__default.default.number(),
      validationPassed: z10__default.default.boolean().optional()
...
${skillInstructions}`;
  ...
  createSkillActivateTool() {
    ...
    return chunkEAZ6YDCQ_cjs.createTool({
      ...
      inputSchema: z10__default.default.object({
        name: z10__default.default.string().describe("The name of the skill to activate")
      }),
      execute: async ({ name }) => {
        if (!skills) {
          return {
  ...
  createSkillReadReferenceTool() {
    ...
    return chunkEAZ6YDCQ_cjs.createTool({
      ...
      inputSchema: z10__default.default.object({
        skillName: z10__default.default.string().describe("The name of the activated skill"),
        referencePath: z10__default.default.string().describe("Path to the reference file (relative to references/ directory)"),
        startLine: z10__default.default.number().optional().describe("Starting line number (1-indexed). If omitted, starts from the beginning."),
        endLine: z10__default.default.number().optional().describe("Ending line number (1-indexed, inclusive). If omitted, reads to the end.")
      }),
  ...
  createSkillReadScriptTool() {
    ...
    return chunkEAZ6YDCQ_cjs.createTool({
      ...
      inputSchema: z10__default.default.object({
        skillName: z10__default.default.string().describe("The name of the activated skill"),
        scriptPath: z10__default.default.string().describe("Path to the script file (relative to scripts/ directory)"),
        startLine: z10__default.default.number().optional().describe("Starting line number (1-indexed). If omitted, starts from the beginning."),
        endLine: z10__default.default.number().optional().describe("Ending line number (1-indexed, inclusive). If omitted, reads to the end.")
      }),
  ...
  createSkillReadAssetTool() {
    ...
    return chunkEAZ6YDCQ_cjs.createTool({
      ...
      inputSchema: z10__default.default.object({
        skillName: z10__default.default.string().describe("The name of the activated skill"),
        assetPath: z10__default.default.string().describe("Path to the asset file (relative to assets/ directory)")
      }),
  ...
  createSkillSearchTool() {
    ...
    return chunkEAZ6YDCQ_cjs.createTool({
      ...
      inputSchema: z10__default.default.object({
        query: z10__default.default.string().describe("The search query"),
        skillNames: z10__default.default.array(z10__default.default.string()).optional().describe("Optional list of skill names to search within"),
        topK: z10__default.default.number().optional().describe("Maximum number of results to return (default: 5)")
      }),
  ...
  async processInputStep({ messageList, tools, stepNumber, requestContext }) {
    ...
    if (hasSkills) {
      ...
      messageList.addSystem({
        role: "system",
        content: 'IMPORTANT: Skills are NOT tools. Do not call skill names directly. To use a skill, call the skill-activate tool with the skill name as the "name" parameter. When a user asks about a topic covered by an available skill, activate it immediately without asking for permission.'
      });
    }
...
var AgentLegacyHandler = class {
  ...
  async prepareLLMOptions(messages, options, methodType) {
    ...
    const resourceIdFromContext = requestContext.get(chunkVDKWYUGC_cjs.MASTRA_RESOURCE_ID_KEY);
    const threadIdFromContext = requestContext.get(chunkVDKWYUGC_cjs.MASTRA_THREAD_ID_KEY);
  ...
  async generateLegacy(messages, generateOptions = {}) {
    ...
    if (!output || experimental_output) {
      ...
      const outputProcessorResult2 = await this.capabilities.__runOutputProcessors({
        requestContext: contextWithMemory || new chunkVDKWYUGC_cjs.RequestContext(),
        tracingContext,
      ...
      options: {
        ...
        onFinish: async (payload) => {
          if (payload.finishReason === "error") {
            ...
            const isUpstreamError = chunkPM3UIIBK_cjs.APICallError.isInstance(payload.error);
            if (isUpstreamError) {
              const providerInfo = provider ? ` from ${provider}` : "";
...
var prepareToolsStepOutputSchema = z10.z.object({
...
function createStreamStep({
  ...
  return createStep({
    ...
    outputSchema: z10.z.instanceof(MastraModelOutput),
    execute: async ({ inputData, tracingContext }) => {
      ...
      const processors = validatedInputData.outputProcessors || (capabilities.outputProcessors ? typeof capabilities.outputProcessors === "function" ? await capabilities.outputProcessors({
        requestContext: validatedInputData.requestContext || new chunkVDKWYUGC_cjs.RequestContext()
...
${errorMessages}`,
   ...
   * ```
   */
  listAgents({ requestContext = new chunkVDKWYUGC_cjs.RequestContext() } = {}) {
  ...
  async listResolvedOutputProcessors(requestContext, configuredProcessorOverrides) {
    const configuredProcessors = configuredProcessorOverrides ? configuredProcessorOverrides : this.#outputProcessors ? typeof this.#outputProcessors === "function" ? await this.#outputProcessors({ requestContext: requestContext || new chunkVDKWYUGC_cjs.RequestContext() }) : this.#outputProcessors : [];
  ...
  async listConfiguredInputProcessors(requestContext) {
    ...
    const configuredProcessors = typeof this.#inputProcessors === "function" ? await this.#inputProcessors({ requestContext: requestContext || new chunkVDKWYUGC_cjs.RequestContext() }) : this.#inputProcessors;
  ...
  async getConfiguredProcessorWorkflows() {
    const workflows = [];
    if (this.#inputProcessors) {
      const inputProcessors = typeof this.#inputProcessors === "function" ? await this.#inputProcessors({ requestContext: new chunkVDKWYUGC_cjs.RequestContext() }) : this.#inputProcessors;
    ...
    if (this.#outputProcessors) {
      const outputProcessors = typeof this.#outputProcessors === "function" ? await this.#outputProcessors({ requestContext: new chunkVDKWYUGC_cjs.RequestContext() }) : this.#outputProcessors;
   ...
   * ```
   */
  async getMemory({ requestContext = new chunkVDKWYUGC_cjs.RequestContext() } = {}) {
    if (!this.#memory) {
      return void 0;
    }
    let resolvedMemory;
   ...
   * ```
   */
  getInstructions({ requestContext = new chunkVDKWYUGC_cjs.RequestContext() } = {}) {
    if (typeof this.#instructions === "function") {
   ...
   * ```
   */
  getDefaultOptions({ requestContext = new chunkVDKWYUGC_cjs.RequestContext() } = {}) {
   ...
   * ```
   */
  getDefaultNetworkOptions({ requestContext = new chunkVDKWYUGC_cjs.RequestContext() } = {}) {
   ...
   * ```
   */
  async getModelList(requestContext = new chunkVDKWYUGC_cjs.RequestContext()) {
  ...
  async listAgentTools({
    ...
    if (Object.keys(agents).length > 0) {
      for (const [agentName, agent] of Object.entries(agents)) {
        const agentInputSchema = z10.z.object({
          prompt: z10.z.string().describe("The prompt to send to the agent"),
          // Using .nullish() instead of .optional() because OpenAI sends null for unfilled optional fields
          threadId: z10.z.string().nullish().describe("Thread ID for conversation continuity for memory messages"),
          resourceId: z10.z.string().nullish().describe("Resource/user identifier for memory messages"),
          instructions: z10.z.string().nullish().describe("Custom instructions to override agent defaults"),
          maxSteps: z10.z.number().min(3).nullish().describe("Maximum number of execution steps for the sub-agent")
        ...
        const agentOutputSchema = z10.z.object({
          text: z10.z.string().describe("The response from the agent"),
          subAgentThreadId: z10.z.string().describe("The thread ID of the agent").optional(),
    ...
    if (Object.keys(workflows).length > 0) {
      for (const [workflowName, workflow] of Object.entries(workflows)) {
        ...
        const toolObj = chunkEAZ6YDCQ_cjs.createTool({
          ...
          outputSchema: z10.z.union([
            z10.z.object({
              // @ts-expect-error - zod types mismatch between v3 and v4
              result: workflow.outputSchema,
              runId: z10.z.string().describe("Unique identifier for the workflow run")
            }),
            z10.z.object({
              runId: z10.z.string().describe("Unique identifier for the workflow run"),
              error: z10.z.string().describe("Error message if workflow execution failed")
            })
          ]),
          mastra: this.#mastra,
            ...
            try {
              ...
              if (result?.status === "success") {
                ...
                return suspend?.(suspendPayload, {
                  ...
                  resumeSchema: resumeSchema ? JSON.stringify(chunk4WQYXT2I_cjs.zodToJsonSchema(resumeSchema)) : void 0
                });
              } else {
                return {
  ...
  async #execute({ methodType, resumeContext, ...options }) {
    ...
    const requestContext = options.requestContext || new chunkVDKWYUGC_cjs.RequestContext();
    const resourceIdFromContext = requestContext.get(chunkVDKWYUGC_cjs.MASTRA_RESOURCE_ID_KEY);
    const threadIdFromContext = requestContext.get(chunkVDKWYUGC_cjs.MASTRA_THREAD_ID_KEY);
  ...
  async network(messages, options) {
    const requestContextToUse = options?.requestContext || new chunkVDKWYUGC_cjs.RequestContext();
    ...
    const runId = mergedOptions?.runId || this.#mastra?.generateId() || crypto2.randomUUID();
    const resourceIdFromContext = requestContextToUse.get(chunkVDKWYUGC_cjs.MASTRA_RESOURCE_ID_KEY);
    const threadIdFromContext = requestContextToUse.get(chunkVDKWYUGC_cjs.MASTRA_THREAD_ID_KEY);
    ...
    return await networkLoop({
      ...
      generateId: (context) => this.#mastra?.generateId(context) || crypto2.randomUUID(),
...
var ModerationProcessor = class _ModerationProcessor {
  ...
  async moderateContent(content, isStream = false, tracingContext) {
    ...
    try {
      ...
      const schema = z10__default.default.object({
        category_scores: z10__default.default.array(
          z10__default.default.object({
            category: z10__default.default.enum(this.categories).describe("The moderation category being evaluated"),
            score: z10__default.default.number().min(0).max(1).describe("Confidence score between 0 and 1 indicating how strongly the content matches this category")
          })
        ).describe("Array of flagged categories with their confidence scores").nullable(),
        reason: z10__default.default.string().describe("Brief explanation of why content was flagged").nullable()
      });
      let response;
...
var PromptInjectionDetector = class _PromptInjectionDetector {
  ...
  async detectPromptInjection(content, tracingContext) {
    ...
    try {
      ...
      let response;
      const baseSchema = z10__default.default.object({
        categories: z10__default.default.array(
          z10__default.default.object({
            type: z10__default.default.enum(this.detectionTypes).describe("The type of attack detected from the list of detection types"),
            score: z10__default.default.number().min(0).max(1).describe("Confidence level between 0 and 1 indicating how certain the detection is")
          })
        ).nullable(),
        reason: z10__default.default.string().describe("The reason for the detection").nullable()
      });
      let schema = baseSchema;
      if (this.strategy === "rewrite") {
        schema = baseSchema.extend({
          rewritten_content: z10__default.default.string().describe("The rewritten content that neutralizes the attack while preserving any legitimate user intent").nullable()
        });
      }
      if (isSupportedLanguageModel(model)) {
...
var PIIDetector = class _PIIDetector {
  ...
  async detectPII(content, tracingContext) {
    ...
    try {
      const model = await this.detectionAgent.getModel();
      const baseDetectionSchema = z10__default.default.object({
        type: z10__default.default.string().describe("Type of PII detected"),
        value: z10__default.default.string().describe("The actual PII value found"),
        confidence: z10__default.default.number().min(0).max(1).describe("Confidence of this detection"),
        start: z10__default.default.number().describe("Start position in the text"),
        end: z10__default.default.number().describe("End position in the text")
      });
      const detectionSchema = this.strategy === "redact" ? baseDetectionSchema.extend({
        redacted_value: z10__default.default.string().describe("Redacted version of the value").nullable()
      }) : baseDetectionSchema;
      const baseSchema = z10__default.default.object({
        categories: z10__default.default.array(
          z10__default.default.object({
            type: z10__default.default.enum(this.detectionTypes).describe("The type of PII detected from the list of detection types"),
            score: z10__default.default.number().min(0).max(1).describe("Confidence level between 0 and 1 indicating how certain the detection is")
          })
        ).describe("Array of detected PII types with their confidence scores").nullable(),
        detections: z10__default.default.array(detectionSchema).describe("Array of specific PII detections with locations").nullable()
      });
      const schema = this.strategy === "redact" ? baseSchema.extend({
        redacted_content: z10__default.default.string().describe("The content with all PII redacted according to the redaction method").nullable()
      }) : baseSchema;
      let response;
      if (isSupportedLanguageModel(model)) {
        response = await this.detectionAgent.generate(prompt, {
...
var LanguageDetector = class _LanguageDetector {
  ...
  async detectLanguage(content, tracingContext) {
    ...
    try {
      ...
      let response;
      const baseSchema = z10__default.default.object({
        iso_code: z10__default.default.string().describe("ISO language code").nullable(),
        confidence: z10__default.default.number().min(0).max(1).describe("Detection confidence").nullable()
      });
      const schema = this.strategy === "translate" ? baseSchema.extend({
        translated_text: z10__default.default.string().describe("Translated text").nullable()
      }) : baseSchema;
      if (isSupportedLanguageModel(model)) {
        response = await this.detectionAgent.generate(prompt, {
          structuredOutput: {
...
var SystemPromptScrubber = class {
  ...
  async detectSystemPrompts(text, tracingContext) {
    try {
      const model = await this.detectionAgent.getModel();
      let result;
      const baseDetectionSchema = z10.z.object({
        type: z10.z.string().describe("Type of system prompt detected"),
        value: z10.z.string().describe("The detected content"),
        confidence: z10.z.number().min(0).max(1).describe("Confidence score"),
        start: z10.z.number().describe("Start position in text"),
        end: z10.z.number().describe("End position in text")
      });
      const detectionSchema = this.strategy === "redact" ? baseDetectionSchema.extend({
        redacted_value: z10.z.string().describe("Redacted value if available").nullable()
      }) : baseDetectionSchema;
      const baseSchema = z10.z.object({
        detections: z10.z.array(detectionSchema).describe("Array of system prompt detections").nullable(),
        reason: z10.z.string().describe("Reason for detection").nullable()
      });
      const schema = this.strategy === "redact" ? baseSchema.extend({
        redacted_content: z10.z.string().describe("Redacted content").nullable()
      }) : baseSchema;
      if (isSupportedLanguageModel(model)) {
...
var ToolSearchProcessor = class {
   ...
   */
  getThreadId(args) {
    return args.requestContext?.get(chunkVDKWYUGC_cjs.MASTRA_THREAD_ID_KEY) || "default";
  }
  /**
  ...
  async processInputStep(args) {
    ...
    const searchTool = chunkEAZ6YDCQ_cjs.createTool({
      ...
      inputSchema: z10.z.object({
        query: z10.z.string().describe('Search keywords (e.g., "weather", "github issue", "database query")')
      }),
      outputSchema: z10.z.object({
        results: z10.z.array(
          z10.z.object({
            name: z10.z.string(),
            description: z10.z.string(),
            score: z10.z.number()
          })
        ),
        message: z10.z.string()
      }),
      execute: async ({ query }) => {
    ...
    const loadTool = chunkEAZ6YDCQ_cjs.createTool({
      ...
      inputSchema: z10.z.object({
        toolName: z10.z.string().describe("The exact name of the tool to load (from search results)")
      }),
      outputSchema: z10.z.object({
        success: z10.z.boolean(),
        message: z10.z.string(),
        toolName: z10.z.string().optional()
      }),
...
var globalEmbeddingCache = new lruCache.LRUCache({
...
exports.MessagePartSchema = MessagePartSchema;
exports.MockMemory = MockMemory;
exports.ModerationProcessor = ModerationProcessor;
exports.PIIDetector = PIIDetector;
exports.ProcessorInputPhaseSchema = ProcessorInputPhaseSchema;
exports.ProcessorInputStepPhaseSchema = ProcessorInputStepPhaseSchema;
exports.ProcessorMessageContentSchema = ProcessorMessageContentSchema;
exports.ProcessorMessageSchema = ProcessorMessageSchema;
exports.ProcessorOutputResultPhaseSchema = ProcessorOutputResultPhaseSchema;
exports.ProcessorOutputStepPhaseSchema = ProcessorOutputStepPhaseSchema;
exports.ProcessorOutputStreamPhaseSchema = ProcessorOutputStreamPhaseSchema;
exports.ProcessorRunner = ProcessorRunner;
exports.ProcessorState = ProcessorState;
exports.ProcessorStepInputSchema = ProcessorStepInputSchema;
exports.ProcessorStepOutputSchema = ProcessorStepOutputSchema;
exports.ProcessorStepSchema = ProcessorStepSchema;
...
exports.ToolSearchProcessor = ToolSearchProcessor;
...
exports.formatCheckFeedback = formatCheckFeedback;
exports.formatCompletionFeedback = formatCompletionFeedback;
exports.formatValidationFeedback = formatValidationFeedback;
exports.generateFinalResult = generateFinalResult;
exports.generateStructuredFinalResult = generateStructuredFinalResult;
exports.getResumeLabelsByStepId = getResumeLabelsByStepId;
exports.getStepIds = getStepIds;
exports.getStepResult = getStepResult;
exports.getThreadOMMetadata = getThreadOMMetadata;
exports.getZodErrors = getZodErrors;
exports.globalEmbeddingCache = globalEmbeddingCache;
exports.hydrateSerializedStepErrors = hydrateSerializedStepErrors;
exports.isObservationalMemoryEnabled = isObservationalMemoryEnabled;
...
exports.runCompletionScorers = runCompletionScorers;
exports.runCountDeprecationMessage = runCountDeprecationMessage;
exports.runDefaultCompletionCheck = runDefaultCompletionCheck;
exports.runValidation = runValidation;
exports.setThreadOMMetadata = setThreadOMMetadata;
...
exports.validateStepRequestContext = validateStepRequestContext;
