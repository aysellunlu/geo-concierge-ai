...
import type { AvailableModel, HeartbeatHandler, HarnessConfig, HarnessEventListener, HarnessMessage, HarnessMode, HarnessSession, HarnessStateSchema, HarnessThread, ModelAuthStatus, PermissionPolicy, PermissionRules, ToolCategory } from './types.js';
/**
...
export declare class Harness<TState extends HarnessStateSchema = HarnessStateSchema> {
     ...
     */
    switchModel(modelId: string, scope?: 'global' | 'thread', modeId?: string): Promise<void>;
    ...
    createThread(title?: string): Promise<HarnessThread>;
    renameThread(title: string): Promise<void>;
    switchThread(threadId: string): Promise<void>;
    listThreads(options?: {
        allResources?: boolean;
    }): Promise<HarnessThread[]>;
    persistThreadSetting(key: string, value: unknown): Promise<void>;
    private removeThreadSetting;
    ...
    setSubagentModelId(modelId: string, agentType?: string): Promise<void>;
    ...
    getMessagesForThread(threadId: string, options?: {
        limit?: number;
    }): Promise<HarnessMessage[]>;
    getFirstUserMessageForThread(threadId: string): Promise<HarnessMessage | null>;
     ...
     */
    respondToPlanApproval(planId: string, response: {
        action: 'approved' | 'rejected';
        feedback?: string;
    }): Promise<void>;
    ...
    removeHeartbeat(id: string): Promise<void>;
