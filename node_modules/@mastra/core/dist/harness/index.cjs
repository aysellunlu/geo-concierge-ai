...
var planCounter = 0;
var askUserTool = chunkEAZ6YDCQ_cjs.createTool({
  id: "ask_user",
  ...
  inputSchema: zod.z.object({
    question: zod.z.string().min(1).describe("The question to ask the user. Should be clear and specific."),
    options: zod.z.array(
      zod.z.object({
        label: zod.z.string().describe("Short display text for this option (1-5 words)"),
        description: zod.z.string().optional().describe("Explanation of what this option means")
      })
...
var submitPlanTool = chunkEAZ6YDCQ_cjs.createTool({
  id: "submit_plan",
  ...
  inputSchema: zod.z.object({
    title: zod.z.string().optional().describe("Short title for the plan (e.g., 'Add dark mode toggle')"),
    plan: zod.z.string().min(1).describe("The full plan content in markdown format. Should include Overview, Steps, and Verification sections.")
  }),
...
- The task is self-contained and can be delegated`,
    inputSchema: zod.z.object({
      agentType: zod.z.enum(subagentIds).describe("Type of subagent to spawn"),
      task: zod.z.string().describe(
      ...
      modelId: zod.z.string().optional().describe("Optional model ID override for this task.")
    }),
