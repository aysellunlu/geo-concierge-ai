      ...
      models: z4.z.array(
        z4.z.object({
          ...
          specification: z4.z.object({
            specificationVersion: z4.z.literal("v3"),
...
var jsonValueSchema = z4.z.lazy(
  () => z4.z.union([
    ...
    z4.z.number(),
    z4.z.boolean(),
    z4.z.record(z4.z.string(), jsonValueSchema.optional()),
...
var outputSchema = z4.z.discriminatedUnion(
  "type",
  [
    z4.z.object({
      type: z4.z.literal("text"),
    ...
    z4.z.object({
      type: z4.z.literal("execution-denied"),
      reason: z4.z.string().optional(),
      providerOptions: providerMetadataSchema.optional()
    }),
    z4.z.object({
    ...
    z4.z.object({
      ...
      value: z4.z.array(
        z4.z.union([
          ...
          z4.z.object({
            type: z4.z.literal("file-url"),
            url: z4.z.string(),
            providerOptions: providerMetadataSchema.optional()
          }),
          z4.z.object({
            type: z4.z.literal("file-id"),
            fileId: z4.z.union([z4.z.string(), z4.z.record(z4.z.string(), z4.z.string())]),
            providerOptions: providerMetadataSchema.optional()
          }),
          z4.z.object({
            type: z4.z.literal("image-data"),
            data: z4.z.string(),
            mediaType: z4.z.string(),
            providerOptions: providerMetadataSchema.optional()
          }),
          z4.z.object({
            type: z4.z.literal("image-url"),
            url: z4.z.string(),
            providerOptions: providerMetadataSchema.optional()
          }),
          z4.z.object({
            type: z4.z.literal("image-file-id"),
            fileId: z4.z.union([z4.z.string(), z4.z.record(z4.z.string(), z4.z.string())]),
            providerOptions: providerMetadataSchema.optional()
          }),
          z4.z.object({
            type: z4.z.literal("custom"),
            providerOptions: providerMetadataSchema.optional()
          })
        ])
      )
...
var toolApprovalRequestSchema = z4.z.object({
  type: z4.z.literal("tool-approval-request"),
  approvalId: z4.z.string(),
  toolCallId: z4.z.string()
});
var toolApprovalResponseSchema = z4.z.object({
  type: z4.z.literal("tool-approval-response"),
  approvalId: z4.z.string(),
  approved: z4.z.boolean(),
  reason: z4.z.string().optional()
});
...
var modelMessageSchema = z4.z.union([
...
async function standardizePrompt(prompt) {
  ...
  const validationResult = await safeValidateTypes({
    value: messages,
    schema: z4.z.array(modelMessageSchema)
  });
