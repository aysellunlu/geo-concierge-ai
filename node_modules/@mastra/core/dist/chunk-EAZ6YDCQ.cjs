...
var SENSITIVE_KEYS = /* @__PURE__ */ new Set([
  chunkVDKWYUGC_cjs.MASTRA_RESOURCE_ID_KEY,
  chunkVDKWYUGC_cjs.MASTRA_THREAD_ID_KEY,
  "apiKey",
  "api_key",
  "token",
  "secret",
...
function normalizeNullishInput(schema, input) {
  ...
  if (chunkBFIOQFGF_cjs.isZodArray(schema)) {
    return [];
  }
...
function coerceStringifiedJsonValues(schema, input) {
  ...
  const unwrapped = chunkBFIOQFGF_cjs.unwrapZodType(schema);
  if (!chunkBFIOQFGF_cjs.isZodObject(unwrapped)) {
    return input;
  }
  ...
  for (const [key, value] of Object.entries(input)) {
    ...
    const baseFieldSchema = chunkBFIOQFGF_cjs.unwrapZodType(fieldSchema);
    if (chunkBFIOQFGF_cjs.getZodTypeName(baseFieldSchema) === "ZodString") {
      continue;
    }
    const trimmed = value.trim();
    if (chunkBFIOQFGF_cjs.isZodArray(baseFieldSchema) && trimmed.startsWith("[") || chunkBFIOQFGF_cjs.isZodObject(baseFieldSchema) && trimmed.startsWith("{")) {
      try {
        const parsed = JSON.parse(value);
        if (chunkBFIOQFGF_cjs.isZodArray(baseFieldSchema) && Array.isArray(parsed) || chunkBFIOQFGF_cjs.isZodObject(baseFieldSchema) && isPlainObject(parsed)) {
          result[key] = parsed;
          changed = true;
        }
      } catch {
        ...
        if (!context) {
          ...
          if (isAgentExecution && !baseContext.agent) {
            ...
            organizedContext = {
              ...
              requestContext: rest.requestContext || new chunkVDKWYUGC_cjs.RequestContext()
            };
            ...
            organizedContext = {
              ...
              requestContext: baseContext.requestContext || new chunkVDKWYUGC_cjs.RequestContext()
            };
          }
        }
...
//# sourceMappingURL=chunk-EAZ6YDCQ.cjs.map
//# sourceMappingURL=chunk-EAZ6YDCQ.cjs.map