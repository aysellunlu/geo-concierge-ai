...
function isToolLoopAgentLike(obj) {
  if (!obj) return false;
  if (obj instanceof chunkA6EWCOGA_cjs.ToolLoopAgent) return true;
  ...
  async handlePrepareStep(args, currentResult) {
    if (this.settings.prepareStep) {
      ...
      if (currentResult.model) {
        const resolvedModel = await chunkQSN5KQXZ_cjs.resolveModelConfig(currentResult.model);
        if (!chunk7S6LA43E_cjs.isSupportedLanguageModel(resolvedModel)) {
...
function toolLoopAgentToMastraAgent(agent, options) {
  ...
  return new chunk7S6LA43E_cjs.Agent({
    ...agentConfig,
    id,
...
//# sourceMappingURL=chunk-G5JVVFIG.cjs.map
//# sourceMappingURL=chunk-G5JVVFIG.cjs.map