import { lazySchema, zodSchema, createJsonErrorResponseHandler, createProviderDefinedToolFactory, createProviderDefinedToolFactoryWithOutputSchema, withoutTrailingSlash, OpenAICompatibleChatLanguageModel, withUserAgentSuffix, generateId, loadApiKey, parseProviderOptions, postJsonToApi, createJsonResponseHandler, combineHeaders, createEventSourceResponseHandler, InvalidResponseDataError, isParsableJson, injectJsonInstructionIntoMessages, APICallError, extractResponseHeaders, safeParseJSON, UnsupportedFunctionalityError, convertToBase64, NoSuchModelError, OpenAICompatibleCompletionLanguageModel, OpenAICompatibleEmbeddingModel, MastraModelGateway, createAnthropic, createOpenAI, createGoogleGenerativeAI, createOpenAICompatible, TooManyEmbeddingValuesForCallError, OpenAICompatibleImageModel, convertBase64ToUint8Array, mediaTypeToExtension, postFormDataToApi, validateTypes, convertUint8ArrayToBase64 } from './chunk-SBPPGJL6.js';
import { createGatewayProvider } from './chunk-CXVMDV2B.js';
...
var DeepSeekChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a15, _b;
    const deepseekOptions = (_a15 = await parseProviderOptions({
  ...
  async doGenerate(options) {
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a15 = toolCall.id) != null ? _a15 : generateId(),
...
var xaiResponsesProviderOptions = z.object({
  /**
...
var xSearchArgsSchema = lazySchema(
  () => zodSchema(
    z.object({
...
var xSearchOutputSchema = lazySchema(
  () => zodSchema(
    z.object({
      query: z.string(),
      posts: z.array(
...
var xSearchToolFactory = createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.x_search",
  name: "x_search",
  inputSchema: lazySchema(() => zodSchema(z.object({}))),
...
var codeExecutionToolFactory = createProviderDefinedToolFactoryWithOutputSchema({
...
var viewImageToolFactory = createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.view_image",
  name: "view_image",
  inputSchema: z.object({}).describe("no input parameters"),
...
var viewXVideoToolFactory = createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.view_x_video",
  name: "view_x_video",
  inputSchema: z.object({}).describe("no input parameters"),
...
var ModelsDevGateway = class extends MastraModelGateway {
  ...
  async resolveLanguageModel({
    ...
    switch (providerId) {
      ...
      case "vercel":
        return createGatewayProvider({ apiKey, baseURL, headers })(modelId);
      case "moonshotai":
      case "moonshotai-cn": {
...
//# sourceMappingURL=chunk-TPDMP7OD.js.map
//# sourceMappingURL=chunk-TPDMP7OD.js.map