...
var entityTypeField = zod.z.nativeEnum(chunkKRAGJ433_cjs.EntityType).describe(`Entity type (e.g., 'agent' | 'processor' | 'tool' | 'workflow')`);
...
var scoringEntityTypeSchema = zod.z.enum(["AGENT", "WORKFLOW", ...Object.values(chunkKRAGJ433_cjs.SpanType)]);
...
var spanTypeField = zod.z.nativeEnum(chunkKRAGJ433_cjs.SpanType).describe("Span type (e.g., WORKFLOW_RUN, AGENT_RUN, TOOL_CALL, etc.)");
...
var TABLE_WORKSPACES = "mastra_workspaces";
var TABLE_WORKSPACE_VERSIONS = "mastra_workspace_versions";
var TABLE_SKILLS = "mastra_skills";
var TABLE_SKILL_VERSIONS = "mastra_skill_versions";
var TABLE_SKILL_BLOBS = "mastra_skill_blobs";
...
var WORKSPACES_SCHEMA = {
  id: { type: "text", nullable: false, primaryKey: true },
  status: { type: "text", nullable: false },
  // 'draft', 'published', or 'archived'
  activeVersionId: { type: "text", nullable: true },
  // FK to workspace_versions.id
  authorId: { type: "text", nullable: true },
  metadata: { type: "jsonb", nullable: true },
  createdAt: { type: "timestamp", nullable: false },
  updatedAt: { type: "timestamp", nullable: false }
};
var WORKSPACE_VERSIONS_SCHEMA = {
  id: { type: "text", nullable: false, primaryKey: true },
...
var SKILLS_SCHEMA = {
  ...
  // 'draft', 'published', or 'archived'
  activeVersionId: { type: "text", nullable: true },
  // FK to skill_versions.id
  authorId: { type: "text", nullable: true },
  createdAt: { type: "timestamp", nullable: false },
  updatedAt: { type: "timestamp", nullable: false }
};
var SKILL_VERSIONS_SCHEMA = {
  id: { type: "text", nullable: false, primaryKey: true },
...
exports.SKILLS_SCHEMA = SKILLS_SCHEMA;
exports.SKILL_BLOBS_SCHEMA = SKILL_BLOBS_SCHEMA;
exports.SKILL_VERSIONS_SCHEMA = SKILL_VERSIONS_SCHEMA;
...
exports.TABLE_SKILLS = TABLE_SKILLS;
exports.TABLE_SKILL_BLOBS = TABLE_SKILL_BLOBS;
exports.TABLE_SKILL_VERSIONS = TABLE_SKILL_VERSIONS;
...
exports.TABLE_WORKSPACES = TABLE_WORKSPACES;
exports.TABLE_WORKSPACE_VERSIONS = TABLE_WORKSPACE_VERSIONS;
exports.TraceStatus = TraceStatus;
exports.WORKSPACES_SCHEMA = WORKSPACES_SCHEMA;
exports.WORKSPACE_VERSIONS_SCHEMA = WORKSPACE_VERSIONS_SCHEMA;
...
//# sourceMappingURL=chunk-KNXZ7KYL.cjs.map
//# sourceMappingURL=chunk-KNXZ7KYL.cjs.map