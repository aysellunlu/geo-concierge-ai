...
async function getRoutingAgent({
  ...
  const workflowList = Object.entries(workflowsToUse).map(([name, workflow]) => {
    return ` - **${name}**: ${workflow.description}, input schema: ${JSON.stringify(
      zodToJsonSchema(workflow.inputSchema ?? z10.object({}))
    )}`;
  }).join("\n");
...
${skillInstructions}`;
  ...
  createSkillReadReferenceTool() {
    ...
    return createTool({
      ...
      inputSchema: z10.object({
        ...
        referencePath: z10.string().describe("Path to the reference file (relative to references/ directory)"),
  ...
  createSkillReadScriptTool() {
    ...
    return createTool({
      ...
      inputSchema: z10.object({
        skillName: z10.string().describe("The name of the activated skill"),
        scriptPath: z10.string().describe("Path to the script file (relative to scripts/ directory)"),
        startLine: z10.number().optional().describe("Starting line number (1-indexed). If omitted, starts from the beginning."),
        endLine: z10.number().optional().describe("Ending line number (1-indexed, inclusive). If omitted, reads to the end.")
      }),
  ...
  createSkillReadAssetTool() {
    ...
    return createTool({
      ...
      inputSchema: z10.object({
        skillName: z10.string().describe("The name of the activated skill"),
        assetPath: z10.string().describe("Path to the asset file (relative to assets/ directory)")
      }),
...
var prepareMemoryStepOutputSchema = z.object({
  ...
  processorStates: z.instanceof(Map),
